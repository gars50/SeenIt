...
def index():
    ...
    if current_user.is_authenticated:
        ...
        return render_template("index.html", total_movie_size=total_movie_size, total_tv_show_size=total_tv_show_size, total_used_space=total_used_space, total_available_space=total_available_space, app_name=app_settings.app_name)